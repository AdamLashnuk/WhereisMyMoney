...
import { ActivityIndicator, Keyboard, RefreshControl, SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
import { getExpenses, getLimits, saveLimit, getSettings, saveSettings, logTextExpense } from './api';

// Visual theme only: restrained banking UI with navy, near-black and leather-brown accents.
const COLORS = {
  bg: '#0A111B',
  surface: '#141F2D',
  ink: '#F5F1E9',
...
function HistoryScreen({ revision }) {
  ...
  return <ScrollView refreshControl={<RefreshControl refreshing={busy} onRefresh={load} tintColor={COLORS.green} />} contentContainerStyle={styles.page}>
...
function LimitsScreen() {
  ...
  return <ScrollView keyboardShouldPersistTaps="handled" refreshControl={<RefreshControl refreshing={loading} onRefresh={load} tintColor={COLORS.green} />} contentContainerStyle={styles.page}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: COLORS.surface, borderRadius: 22, borderWidth: 1, borderColor: COLORS.border, padding: 20, marginBottom: 12 },
  hero: { backgroundColor: COLORS.navy, borderColor: COLORS.navySoft, alignItems: 'center', paddingVertical: 22 }, heroEyebrow: { fontSize: 10, fontWeight: '800', letterSpacing: 2, color: '#E9C99B' }, micCircle: { width: 70, height: 70, borderRadius: 35, backgroundColor: COLORS.brown, alignItems: 'center', justifyContent: 'center', marginTop: 18, marginBottom: 14 }, micIcon: { fontSize: 35, color: COLORS.white }, heroTitle: { fontSize: 22, fontWeight: '800', color: COLORS.white, textAlign: 'center' }, heroDescription: { fontSize: 13, color: '#DAE3EB', textAlign: 'center', lineHeight: 20, marginTop: 10 },
  input: { backgroundColor: '#0D1724', borderRadius: 12, borderWidth: 1, borderColor: COLORS.border, color: COLORS.ink, padding: 13, fontSize: 15, marginVertical: 12 }, textArea: { minHeight: 80, textAlignVertical: 'top' }, button: { backgroundColor: COLORS.navySoft, borderRadius: 12, padding: 15, alignItems: 'center', marginTop: 4 }, buttonText: { fontWeight: '800', color: COLORS.white }, outlineButton: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.green }, outlineText: { color: COLORS.green }, disabled: { opacity: 0.5 }, error: { color: COLORS.red, fontSize: 13, lineHeight: 19, marginVertical: 12 }, saved: { color: COLORS.green, fontSize: 13, marginBottom: 12, fontWeight: '700' }, warning: { color: COLORS.amber, marginTop: 12, fontSize: 13, lineHeight: 20 },
  ...
  totalCard: { backgroundColor: COLORS.navy, borderColor: COLORS.navySoft, paddingVertical: 27 }, totalLabel: { color: '#E9C99B', fontSize: 10, letterSpacing: 1.4, fontWeight: '800' }, totalAmount: { color: COLORS.white, fontSize: 48, fontWeight: '800', letterSpacing: -2, marginTop: 10 }, totalHint: { color: '#DAE3EB', marginTop: 5, fontSize: 12 }, categoryRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', minHeight: 42 }, categoryBorder: { borderTopWidth: 1, borderTopColor: COLORS.border }, categoryName: { fontSize: 14, fontWeight: '600', color: COLORS.ink }, categoryAmount: { fontSize: 14, fontWeight: '800', color: COLORS.ink }, expenseCard: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center' }, expenseAmount: { fontSize: 15, fontWeight: '800', color: COLORS.ink }, original: { width: '100%', borderTopWidth: 1, borderTopColor: COLORS.border, marginTop: 15, paddingTop: 15, color: COLORS.muted, fontSize: 13, lineHeight: 20 },
  success: { borderColor: '#98724D' }, successTitle: { fontSize: 14, fontWeight: '800', color: COLORS.green }, resultAmount: { fontSize: 34, fontWeight: '800', color: COLORS.ink, marginTop: 8 }, resultCategory: { fontSize: 15, color: COLORS.green, marginVertical: 6, fontWeight: '700' }, alert: { backgroundColor: '#35271D', borderColor: '#896442' }, alertTitle: { color: COLORS.amber, fontSize: 16, fontWeight: '800' },
  notice: { backgroundColor: COLORS.pale, borderColor: COLORS.border }, noticeTitle: { fontSize: 15, fontWeight: '800', color: COLORS.green }, noticeText: { fontSize: 13, lineHeight: 20, color: COLORS.ink, marginTop: 7 }, limitRow: { paddingVertical: 11 }, limitControls: { flexDirection: 'row', alignItems: 'center', marginTop: 3 }, dollarSign: { color: COLORS.ink, fontSize: 17, fontWeight: '800' }, limitInput: { flex: 1, marginHorizontal: 8, marginVertical: 5 }, smallButton: { backgroundColor: COLORS.navySoft, padding: 12, borderRadius: 10 }, smallButtonText: { color: COLORS.white, fontWeight: '800' }, fieldTitle: { marginTop: 22 }, pills: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 13 }, pill: { borderRadius: 10, borderWidth: 1, borderColor: COLORS.border, paddingVertical: 10, paddingHorizontal: 12 }, selectedPill: { backgroundColor: COLORS.brown, borderColor: COLORS.green }, pillText: { fontSize: 12, fontWeight: '700', color: COLORS.ink }, selectedText: { color: COLORS.white }, schedule: { marginTop: 17, marginBottom: 10, backgroundColor: COLORS.pale, borderRadius: 12, padding: 14 }, scheduleText: { color: COLORS.ink, fontWeight: '800', fontSize: 13 },
  tabBar: { backgroundColor: '#090F18', borderTopWidth: 1, borderTopColor: COLORS.border, flexDirection: 'row', paddingTop: 11, paddingBottom: 9 }, tab: { flex: 1, alignItems: 'center', paddingVertical: 3 }, tabSymbol: { fontSize: 23, color: '#8493A5', marginBottom: 3 }, tabLabel: { color: '#9BA9B8', fontSize: 11, fontWeight: '700' }, tabActive: { color: COLORS.green },
});
